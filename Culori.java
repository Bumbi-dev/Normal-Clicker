...
public final class Culori {
    public static final Color fundal = new Color(240,240,240,255);
    ...
    public static final Color bonus = new Color(255, 234, 0);     // 250, 250, 51                  255, 234, 0
    public static final Color question = new Color(156, 33, 211); // 197,97, 255 ... 94,28,158     156, 33, 211
}